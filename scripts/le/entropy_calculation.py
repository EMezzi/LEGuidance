...
class LEAgent:
            ...
            input=[
                ...
                },
                {
                    ...
                    "content": [
                        {
                            "type": "input_text",
                            "text": user_prompt_modality.format(question=question, images_text=images_text,
    ...
    @staticmethod
    def extract_partitions(model, question, mod_chosen, question_text, partitions_path):
